...
{{--
    ...
    One icon language across the whole app, with a single stroke width and
    viewBox so nothing looks visually heavier than its neighbours. The paths are
    embedded rather than pulled from a package because there is no JS build step
    here and the app must work with no network.

    Icons are decorative by default (aria-hidden) — every control that uses one
    still carries its own accessible text, since an icon alone never tells a
    screen reader what a button does.
--}}
@php
    $paths = [
        ...
        'piggy-bank' => '<path d="M11 17h3v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-3a3.16 3.16 0 0 0 2-2h1a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1h-1a5 5 0 0 0-2-4V3a4 4 0 0 0-3.2 1.6l-.3.4H11a6 6 0 0 0-6 6v1a5 5 0 0 0 2 4v3a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1z"/><path d="M16 10h.01"/>',
